...
m.units.specialist = {
	...
	{ id = "renegade_sniper",          translate_key = "translate_renegade_sniper",          r=255, g=255, b=255, dist=50, enabled=true, comment = "血痂狙击手" },
...
m.units.monster = {
	...
	{ id = "chaos_daemonhost",         translate_key = "translate_chaos_daemonhost",         r=255, g=0,   b=255, dist=50, enabled=false, comment = "恶魔宿主" },
